...
class EnvConstants:
    ...
    """
    P: float = 101.20  # Atmospheric pressure (k Pa)
    k: float = 0.4  # von Karman's constant
    sigma: float = 5.67E-08  # Stefan-Boltzmann constant (W m-2 K-4)
    KR: int = 200  # Parameter in Eq (24.2)
    KD1: float = -0.307  # Parameter in Eq (24.6) (kPa ^ -1)
    KD2: float = 0.019  # Parameter in Eq (24.6) (kPa ^ -1)
    TL: float = 273.00  # Parameter in Eq (24.4) and Eq (24.5) (K)
    T0: float = 293.00  # Parameter in Eq (24.4) and Eq (24.5) (K)
    TH: float = 313.00  # Parameter in Eq (24.4) and Eq (24.5) (K)
...
class ForestConstants:
    ...
    :param d (float) : Zero plane displacement height (m).
    :param z0 (float) : Aerodynamic roughness height (m).
    ...
    zm: float = 22  # Measurement height for wind speed/temperature
    Scanmax: float = 4.00  # (mm)
...
class GrassConstants:
    ...
    z0: float = 0.013  # aerodynamic roughness height
    ...
    SMinit: float = 20.00  # Initial Root-accessible soil moisture
    S: float = 2.00  # Maximum Canopy Water Storage
    zm: float = 2  # Measurement height for wind speed/temperature
    Scanmax: float = 2.00  # Canopy maximum storage
